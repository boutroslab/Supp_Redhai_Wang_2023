...
screen_result_apc <- read_excel("FINAL modifier screen apc .xlsx", range = "A3:T126")
...
expression_data <- read_excel("APC_data.xlsx", col_names = FALSE)
...
pla_negative_gfp <- read_excel("PLA quantifications.xlsx", range = "C6:AD35") %>% select(matches("Distance|Gray_Value")) 
...
pla_negative_rfp <- read_excel("PLA quantifications.xlsx", range = "C39:AD68") %>% select(matches("Distance|Gray_Value")) 
...
pla_positive_gfp <- read_excel("PLA quantifications.xlsx", range = "C75:AD104") %>% select(matches("Distance|Gray_Value")) 
...
pla_positive_rfp <- read_excel("PLA quantifications.xlsx", range = "C107:AD136") %>% select(matches("Distance|Gray_Value")) 
...
fz3_intestine_control <- read_excel("Fz3 quantification along intestine myots.xlsx", range = "G10:L6139") %>% select(matches("X|Y")) 
...
fz3_intestine_dcr_apc <- read_excel("Fz3 quantification along intestine myots.xlsx", range = "O10:T6102") %>% select(matches("X|Y")) 
